...
- (void)layoutSubviews
{
    ...
    _indexLabel.center = CGPointMake(self.bounds.size.width * 0.5,ZL_IS_IPHONE_X?59:35);
        ...
        if (collView.scrollEnabled) {
            ...
            if ([collView.collectionViewLayout isKindOfClass:[UICollectionViewFlowLayout class]] ) {
                ...
                if (layout.scrollDirection == UICollectionViewScrollDirectionVertical) {
                    [collView scrollToItemAtIndexPath:path atScrollPosition:UICollectionViewScrollPositionBottom animated:NO];
                }else{
